...
export default function UserInfoCard() {
  ...
  if (!publicKey)
    return (
      <div className="text-white text-center text-2xl mt-10 h-full w-full flex justify-center items-center text-bold ">
        No wallet connected
      </div>
    );
  ...
  return (
    <div
      className="p-5 grid gap-5 border-[#03B500] border text-white bg-[#111411] mt-5"
      style={{
